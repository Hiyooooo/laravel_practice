        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="{{ route('datasiswa') }}" :active="request()->routeIs('datasiswa')">Student
                List</x-nav-link>
              <x-nav-link href="{{ route('guardians') }}" :active="request()->routeIs('guardians')">Guardians
                List</x-nav-link>
              ...
              <a href="/profil" 
                class="{{ request()->is('profil') ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white" }} rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:text-white">Profile</a> -->
            </div>
          </div>
        </div>
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              <button
                ...
                <img
                  src="https://media.discordapp.net/attachments/1393115681687470130/1414972792247685302/Chicho.jpeg?ex=68c1839a&is=68c0321a&hm=6e1e29d819b4dd58d635a3098e9e91f8b14e154897300555e3800af0c1589e0c&=&format=webp&width=759&height=759"
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      ...
      <div class="border-t border-white/10 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img
              src="https://cnc-magazine.oramiland.com/parenting/images/biodata-deddy-corbuzier.width-800.format-webp.webp"
              alt="dedi" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
          </div>
          <div class="ml-3">
