            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="simple-search" name="search" value="{{ request('search') }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                              ...
                                              dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search teacher...">
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="w-full md:w-auto flex justify-end">
                        <button type="button" data-modal-target="addTeacherModal" data-modal-toggle="addTeacherModal"
                            ...
                            @foreach ($teachers as $t)
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        {{-- Tombol 3 titik --}}
                                        <button id="teacher-actions-{{ $t->id }}-button"
                                            data-dropdown-toggle="teacher-actions-{{ $t->id }}" type="button" class="inline-flex items-center p-0.5 text-sm font-medium text-center
                                        ...
                                        <div id="teacher-actions-{{ $t->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow
                                                       dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="teacher-actions-{{ $t->id }}-button">
                                                <li>
                                                    <button type="button" data-modal-target="editTeacherModal-{{ $t->id }}"
                                                        data-modal-toggle="editTeacherModal-{{ $t->id }}" class="w-full text-left block py-2 px-4 hover:bg-gray-100
                                                ...
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="deleteTeacherModal-{{ $t->id }}"
                                                        data-modal-toggle="deleteTeacherModal-{{ $t->id }}" class="w-full text-left block py-2 px-4 text-red-600 hover:bg-gray-100
                ...
                {{-- MODAL EDIT & DELETE PER TEACHER --}}
                @foreach ($teachers as $teacher)
                    @include('admin.teacher.update', ['teacher' => $teacher, 'subjects' => $subjects])
